...
#    Updated: 2023/01/18 19:49:40 by gsmereka         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
HEADERS_BONUS	=	./headers/checker.h ./headers/objects_bonus.h ./headers/utils.h 
...
SRC				=	main.c check_args.c set_numbers.c sort_utils.c \
...
SRC_B			=	check_args.c finalize.c initialize.c set_numbers.c \
					...
					checker.c get_next_line_clean.c get_instructions.c \
